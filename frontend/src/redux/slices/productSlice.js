...
export const fetchProductsByFilters = createAsyncThunk('products/fetchByFilters', async ({
    ...
    // const response = await axios.get(`http://localhost:9000/api/?${query.toString()}`)
    // const response = await axios.get(`http://localhost:9000/api/products?collection=all&size=XS,M&gender=Women&maxPrice=100&limit=3`)
    // const response = await axios.get(`http://localhost:9000/api/products/S${query.toString()}`)
...
// const response = await axios.get(`http://localhost:9000/api/products?collection=all&size=XS&gender=Women&maxPrice=100&limit=2`)
