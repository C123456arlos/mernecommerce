...
const AdminHomePage = () => {
    ...
    return (
        <div className="max-w-7xl mx-auto p-6">
            ...
            {productsLoading || ordersLoading ? (<p>loading</p>) : productsError ? (<p className="text-red-500">error fetching {productsError}</p>) : ordersError ? (<p className="text-red-500">error fetching orders {ordersError}</p>) : (
